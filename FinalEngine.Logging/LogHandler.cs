...
namespace FinalEngine.Logging
{
    ...
    /// <summary>
    ///     Provides an abstraction representation of an <see cref="ILogHandler"/> that provides the
    ///     ability to assure correct formatting of messages.
    /// </summary>
    ...
    public abstract class LogHandler : ILogHandler
    {
        ...
        ///     Specifies a <see cref="ILogFormatter"/> that represents the formatter that will
        ///     format a message before it is logged.
        /// </param>
        ...
        /// </param>
        /// <remarks>
        ///     When implementing this method in a derived class, you should always remember to call
        ///     the <see cref="ILogFormatter.GetFormattedLog(LogType, string)"/> method of the <see
        ///     cref="Formatter"/> property to allow the message to be formatted before it is logged.
        /// </remarks>
