...
{
    /// <summary>
    ///     Defines an interface that provides methods for invocation of an OpenTK Native Window.
    /// </summary>
    public interface INativeWindowInvoker
    {
        ...
        ///     window, by calling <see cref="Close"/> or hitting the 'close' button. If this
        ///     property is true, it is no longer safe to use any OpenTK.Input or
